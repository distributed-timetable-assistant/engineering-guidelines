...
فایل‌های ADR باید با استفاده از یک شماره ترتیبی و یک عنوان کوتاه توصیفی، که با خط تیره جدا شده‌اند، نام‌گذاری شوند. فرمت به این صورت است: `NNNN-title-of-the-decision.md`.

مثال: `0001-record-architecture-decisions.md`
